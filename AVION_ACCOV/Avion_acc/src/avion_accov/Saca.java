...
public class Saca {
    ...
    public Saca(Radar_detector radar){
        this.radar = radar;
    }
    ...
    void traitement(Socket connectionSocket){
        ...
        try{
            ...
            s = inFromClient.readLine().split("/"); //id/nom/arrivee
                ...
                resultat = c.calculPosition(Double.parseDouble(s[2]),Double.parseDouble(s[3]),Double.parseDouble(s[4]),0,0,0,0,0);
            ...
            while (true){
                ...
                if((position.length >= 4)&&(position[3].equals("end"))){
                    ...
                    connectionSocket.close();
                        ...
                        resultat = c.calculPosition(Double.parseDouble(position[0]), Double.parseDouble(position[1]),Double.parseDouble(position[2]),Double.parseDouble(res[3]), Double.parseDouble(res[4]));
