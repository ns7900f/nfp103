...
public class Radar_detector{
    ...
    String[] information = {"id","nom","pos_x","pos_y","pos_z","cap","vitesse_x","vitesse_y","vitesse_z","altitude","remarque"};
    ...
    void afficher(String id,String nom,String pos_x,String pos_y,String pos_z,String vitesse_x,String vitesse_y,String vitesse_z,String cap,String altitude,String remarque){
        synchronized (key) {
            boolean found =false;
            for (int i=0;i<listAvions.size();i++){
                if(listAvions.get(i).equals(id)){
                   /* listAvions.get(i).add(1, nom);
                    listAvions.get(i).add(2, pos_x);
                    listAvions.get(i).add(3, pos_y);
                    listAvions.get(i).add(4, pos_z);
